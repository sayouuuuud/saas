...
export default function Page() {
  ...
  return (
    <main className="site-shell">
      ...
      <footer className="site-footer section-container"><div className="footer-main"><div className="footer-brand"><Link href="/" className="brand"><BrandMark /><span>مركزية</span></Link><p>مساحة واحدة لإدارة اشتراكك ومنصتك التعليمية بوضوح.</p></div><div className="footer-links"><div><b>المنتج</b><a href="#features">المزايا</a><a href="#how-it-works">كيف تعمل</a><a href="#pricing">الأسعار</a></div><div><b>المساعدة</b><a href="#faq">الأسئلة الشائعة</a><Link href="/contact">تواصل معنا</Link><Link href="/resources/status">حالة النظام</Link></div><div><b>قانوني</b><Link href="/privacy">الخصوصية</Link><Link href="/terms">الشروط</Link><Link href="/refund-policy">سياسة الاسترداد</Link><Link href="/acceptable-use">الاستخدام المقبول</Link></div></div></div><div className="footer-bottom"><span>© 2025 مركزية. جميع الحقوق محفوظة.</span><span className="footer-note"><Clock3 size={14} /> مبنية للوضوح، لا للتعقيد.</span></div></footer>
    </main>
  )
}
