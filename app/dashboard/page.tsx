  ...
  return (
    <main className="dashboard-page">
      <aside className={`app-sidebar ${mobileOpen ? 'is-open' : ''}`}>
        ...
        <div className="app-sidebar-bottom"><div className="app-user"><span className="mini-avatar">{name.slice(0, 1)}</span><span><b>{name}</b><small>المالك</small></span></div><button type="button" aria-label="إعدادات الحساب"><Settings size={15} /></button></div>
      </aside>
