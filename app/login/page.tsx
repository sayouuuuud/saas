      ...
      <section className="auth-panel auth-form-panel">
        ...
        <div className="auth-form-wrap">
          ...
          <form className="auth-form" onSubmit={submit}>
            ...
            <label>كلمة المرور<div className="input-with-icon"><LockKeyhole size={15} /><input required minLength={6} value={password} onChange={(event) => setPassword(event.target.value)} type="password" autoComplete={mode === 'signup' ? 'new-password' : 'current-password'} placeholder="6 أحرف على الأقل" /></div></label></>}
