...
type LmsLink = { id: string; displayName: string; publicUrl: string; adminUrl: string | null; status: string; lastCheckedAt: string | null; createdAt: string }
